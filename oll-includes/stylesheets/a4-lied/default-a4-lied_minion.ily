...
%{
   includes/stylesheets/default-a4-lied_minion.ily
   
   Stylesheet for a voice-piano song on A4 paper
   with the Minion Pro font-set
   
   You have to have the (non-free) Adobe Minion Pro fonts
   installed on your system to be able to use this stylesheet.
...
\include "../fontsets/fontset-minionpro.ily"
