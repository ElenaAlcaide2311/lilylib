...
%{
 OLLib/editorialToolbox/editorialToolbox.ily

  This library is part of openLilyLib's OLLib
  and may also be included separately.
  
  The editorial toolbox contains 
  - functions to handle editor's additions/amendments
  - functions to add functionality to communicate between editors
%}
